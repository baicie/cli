  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-android-arm64/package.json').version
        if (
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-android-arm-eabi/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
    ...
    if (process.arch === 'x64') {
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-win32-x64-msvc/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-win32-ia32-msvc/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-win32-arm64-msvc/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
    ...
    try {
      ...
      const bindingPackageVersion =
        require('@napi-rs/package-template-darwin-universal/package.json').version
      if (
        bindingPackageVersion !== '1.0.0' &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
    ...
    if (process.arch === 'x64') {
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-darwin-x64/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-darwin-arm64/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
    ...
    if (process.arch === 'x64') {
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-freebsd-x64/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-freebsd-arm64/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
    ...
    if (process.arch === 'x64') {
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-x64-musl/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-x64-gnu/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-arm64-musl/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-arm64-gnu/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-arm-musleabihf/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-arm-gnueabihf/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-loong64-musl/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-loong64-gnu/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-riscv64-musl/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@napi-rs/package-template-linux-riscv64-gnu/package.json').version
          if (
            bindingPackageVersion !== '1.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-linux-ppc64-gnu/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-linux-s390x-gnu/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-openharmony-arm64/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-openharmony-x64/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      try {
        ...
        const bindingPackageVersion =
          require('@napi-rs/package-template-openharmony-arm/package.json').version
        if (
          bindingPackageVersion !== '1.0.0' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
